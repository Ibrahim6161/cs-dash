...
const { buildDashboard } = require("./dashboard-analytics");
    ...
    const steps = [
      {
        ...
        command: node,
        args: [path.join(this.rootDir, "scrape-csstonks.js"), path.resolve(this.rootDir, paths.cases)],
      },
      {
        id: "details",
        label: "Case details",
        command: node,
        args: [
          path.join(this.rootDir, "scrape-case-details.js"),
          "--cases",
      ...
      {
        id: "pricempire",
        label: "PriceEmpire marketplaces",
        optional: true,
        command: node,
        args: [
          path.join(this.rootDir, "scrape-pricempire-marketplaces-eur.cjs"),
          "--out",
          path.resolve(this.rootDir, paths.pricempire),
          "--page",
          String(refresh.pricePage),
          "--limit",
